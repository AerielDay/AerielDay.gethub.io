    ...
    e.dropotron = function(t) {
        ...
        s.each(function() {
            ...
            t.disableSelection_dropotron().hide().addClass(o.menuClass).css("position", "absolute").on("mouseenter", function(e) {
                ...
                s.each(function() {
                    var t = e(this);
                    if (!e.contains(t.get(0), n.get(0))) t.trigger("doCollapse");
                });
        ...
        s.find("a").css("display", "block").on("click touchend", function(t) {
            if (!r && e(this).attr("href").length < 1) {
                t.preventDefault();
            }
        });
        ...
        n.children("li").each(function() {
            ...
            if (s.length > 0) {
                if (o.detach && o.cloneOnDetach) {
                    t = s.clone();
                    t.attr("class", "").hide().appendTo(s.parent());
                }
                if (o.detach) s.detach().appendTo(i);
                for (var a = o.baseZIndex, l = 1, r = s; r.length > 0; l++) {
                    r.css("z-index", a++);
                    if (o.submenuClassPrefix) r.addClass(o.submenuClassPrefix + (a - 1 - o.baseZIndex));
                    r = r.find("> li > ul");
                }
            }
        });
